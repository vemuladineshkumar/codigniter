...
<form method="post" action="/code/product/add">
	<div class="form-group">
		<label for="p_name" class="col-md-4 control-label">P Name</label>
		<div class="col-md-8">
			<input type="text" name="p_name" value="<?php echo $this->input->post('p_name'); ?>" class="form-control" id="p_name" />
		</div>
	</div>
	<div class="form-group">
		<label for="p_description" class="col-md-4 control-label">P Description</label>
		<div class="col-md-8">
			<input type="text" name="p_description" value="<?php echo $this->input->post('p_description'); ?>" class="form-control" id="p_description" />
		</div>
	</div>
	<div class="form-group">
		<label for="p_price" class="col-md-4 control-label">P Price</label>
		<div class="col-md-8">
			<input type="text" name="p_price" value="<?php echo $this->input->post('p_price'); ?>" class="form-control" id="p_price" />
		</div>
	</div>
	<div class="form-group">
		<label for="p_img" class="col-md-4 control-label">P Img</label>
		<div class="col-md-8">
			<input type="text" name="p_img" value="<?php echo $this->input->post('p_img'); ?>" class="form-control" id="p_img" />
		</div>
	</div>
	<div class="form-group">
		<label for="cat_id" class="col-md-4 control-label">Cat Id</label>
		<div class="col-md-8">
			<input type="text" name="cat_id" value="<?php echo $this->input->post('cat_id'); ?>" class="form-control" id="cat_id" />
		</div>
	</div>
	<div class="form-group">
		<label for="subcat_id" class="col-md-4 control-label">Subcat Id</label>
		<div class="col-md-8">
			<input type="text" name="subcat_id" value="<?php echo $this->input->post('subcat_id'); ?>" class="form-control" id="subcat_id" />
		</div>
	</div>
	<div class="form-group">
